...
const CONCERN_PATTERNS: Record<WellbeingConcern, { keywords: string[]; phrases: string[]; weight: number }> = {
    ...
    [WellbeingConcern.DEPRESSION]: {
        ...
        phrases: [
            "what's the point", "don't care anymore", 'nothing matters',
    ...
    [WellbeingConcern.SUICIDAL_IDEATION]: {
        keywords: ['suicide', 'kill myself', 'end it', 'die'],
        phrases: [
            'want to die', "don't want to live", 'better off dead',
            'end my life', 'not be here', 'give up on life',
            'no reason to go on', "can't take it anymore",
